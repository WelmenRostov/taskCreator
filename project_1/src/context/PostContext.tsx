...
export const PostProvider: React.FC<{ children: ReactNode }> = ({children}) => {
    // Считываем из localStorage и преобразуем даты
    const storedPosts = (() => {
        try {
    ...
    // Дефолтные задачи (начальное состояние)
    ...
    /**
     * Обновление только статуса поста
     */
    ...
    /**
     * Добавление поста через модалку (и её закрытие)
     */
    ...
    /**
     * Добавляет новый или обновляет существующий пост
     */
