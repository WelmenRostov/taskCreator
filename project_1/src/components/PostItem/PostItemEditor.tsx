...
const PostItemEditor = ({index, handleSave, setEditableTitle, setEditableText, editableTitle, editableText, removePost, id, data, status}:EditorProps) => {
    return (
            <form>
                <div
                    ...
                    <div className={'grid grid-flow-row-dense grid-cols-1 grid-rows-1'}>
                        ...
                        <MyButton
                            className="m-2 col-end-4 row-end-1"
                            onClick={(e) => {
                                e.preventDefault();
                                removePost(index);
                            }}
